...
type EnhancementSelectionProps = {
  options:
    | {
        name: string;
        description: string;
        chosen: boolean;
        source: string;
        applicableKeywords?: string[] | undefined;
      }[]
    | null
    | undefined;
  placeholder?: string;
...
const EnhancementSelection = (
  props: UseControllerProps<any> & EnhancementSelectionProps,
) => {
  ...
  return (
    <Listbox value={value} onChange={onChange} by="name">
      {({ open }) => (
        <>
